...
#include "BloqueBuilderLadrillo.h"
#include "BloqueBuilderPasto.h"
#include <functional>
#include "Pieces.generated.h"

UCLASS()
class TETRIS_UE4_API APieces : public AActor, public IObservable
{
	GENERATED_BODY()
...
public:
    static APieces* instancia; //Puntero a instancia (nullptr)
    static APieces* GetInstanciaPieces(); //Obtener instancia 
